...
from .views import product_list, product_detail, store_product_list, store_product_detail, add_product, add_store_product, update_product ,update_store_product, delete_product, delete_store_product
